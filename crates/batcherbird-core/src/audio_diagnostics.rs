...
impl AudioDiagnostics {
    ...
    pub fn new(sample_rate: u32, buffer_size: u32) -> Self {
        let callback_duration_ns =
            (buffer_size as f64 / sample_rate as f64 * 1_000_000_000.0) as u64;
    ...
    pub fn record_midi_event(&self, timing_jitter_ns: u64) {
        ...
        self.midi_timing_jitter_ns
            .fetch_add(timing_jitter_ns, Ordering::Relaxed);
    }
    ...
    pub fn get_performance_report(&self) -> AudioPerformanceReport {
        ...
        AudioPerformanceReport {
            ...
            min_execution_time_ns: if min_execution_time_ns == u64::MAX {
                0
            } else {
                min_execution_time_ns
            },
            cpu_utilization_percent: (avg_execution_time_ns as f64
                / self.target_callback_time_ns as f64
                * 100.0) as f32,

            lock_attempts,
            lock_contentions,
            lock_contention_rate: if lock_attempts > 0 {
                lock_contentions as f32 / lock_attempts as f32
            } else {
                0.0
            },
...
mod tests {
    ...
    fn test_performance_status() {
        ...
        assert_eq!(
            diagnostics.get_performance_status(good_time),
            PerformanceStatus::Good
        );
    }
}
